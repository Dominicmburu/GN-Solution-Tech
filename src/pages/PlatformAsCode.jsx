        ...
        return (
          <div className="container py-5">
            ...
            <div className="platform-stack">
              <motion.div className="stack-layer" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.1 }}>
                <div className="stack-icon"><FaRocket /></div>
                <div className="stack-content">
                  <h5>Applications</h5>
                  <p>Microservices, APIs, Web Applications</p>
                </div>
              </motion.div>
              <motion.div className="stack-layer" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
                <div className="stack-icon"><FaJenkins /></div>
                <div className="stack-content">
                  <h5>CI/CD & DevOps</h5>
                  <p>Automated Build, Test, Deploy Pipelines</p>
                </div>
              </motion.div>
              <motion.div className="stack-layer" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }}>
                <div className="stack-icon"><FaDocker /></div>
                <div className="stack-content">
                  <h5>Containers & Orchestration</h5>
                  <p>Docker, Kubernetes, Service Mesh</p>
                </div>
              </motion.div>
              <motion.div className="stack-layer" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4 }}>
                <div className="stack-icon"><FaCogs /></div>
                <div className="stack-content">
                  <h5>Middleware & Services</h5>
                  <p>Databases, Message Queues, Caches</p>
                </div>
              </motion.div>
              <motion.div className="stack-layer" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.5 }}>
                <div className="stack-icon"><FaServer /></div>
                <div className="stack-content">
                  <h5>Infrastructure</h5>
                  <p>Compute, Storage, Networking</p>
                </div>
              </motion.div>
            </div>
            ...
            <div className="metrics-banner mt-5">
              ...
              <div className="metrics-container">
                ...
                >
                  ...
                  <div className="metric-label">Faster Time to Value</div>
                </motion.div>
                <motion.div 
                  className="metric" 
                  initial={{ scale: 0.8, opacity: 0 }} 
                ...
                >
                  ...
                  <div className="metric-label">Reduction in Deployment Errors</div>
                </motion.div>
                <motion.div 
                  className="metric" 
                  initial={{ scale: 0.8, opacity: 0 }} 
                ...
                >
                  ...
                  <div className="metric-label">Reduction in Development Costs</div>
                </motion.div>
                <motion.div 
                  className="metric" 
                  initial={{ scale: 0.8, opacity: 0 }} 
                ...
                >
                  ...
                  <div className="metric-label">More Releases per Month</div>
                </motion.div>
              </div>
            </div>
          </div>
              ...
              <div className="resources-grid">
                <div className="resource-card">
                  ...
                  <ul className="list-unstyled">
                    <li><FaArrowRight className="me-2 text-primary" /> Platform as Code Best Practices</li>
                    <li><FaArrowRight className="me-2 text-primary" /> Kubernetes & Docker Guides</li>
                    <li><FaArrowRight className="me-2 text-primary" /> CI/CD Implementation Strategies</li>
                  </ul>
                </div>
                <div className="resource-card">
                  <h5>Training</h5>
                  <ul className="list-unstyled">
                    <li><FaArrowRight className="me-2 text-primary" /> DevOps & Platform Engineering</li>
                    <li><FaArrowRight className="me-2 text-primary" /> Container Orchestration</li>
                    <li><FaArrowRight className="me-2 text-primary" /> GitOps Workflow Workshop</li>
                  </ul>
                </div>
                <div className="resource-card">
                  <h5>Community</h5>
                  <ul className="list-unstyled">
                    <li><FaArrowRight className="me-2 text-primary" /> Platform Engineering Community</li>
                    <li><FaArrowRight className="me-2 text-primary" /> Cloud Native Computing Foundation</li>
                    <li><FaArrowRight className="me-2 text-primary" /> DevOps Exchange Forums</li>
                  </ul>
                </div>
              </div>
            </div>
